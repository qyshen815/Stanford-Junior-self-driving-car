...
public:
    RoadNetwork();
    RoadNetwork(const std::string& strName);
  ...
  Segment* getSegment(const std::string& strName);
  ...
  WayPoint* addWayPoint(Lane* pLane, const double& lat, const double& lon);
  WayPoint* addWayPoint(Lane* pLane, const double& lat, const double& lon, uint32_t insert_before);
  WayPoint* addWayPoint(Lane* pLane, const std::string& strName, const double& lat, const double& lon);
  WayPoint* addWayPoint(Lane* pLane, const std::string& strName, const double& lat, const double& lon, uint32_t insert_before);
  ...
  Perimeter* getPerimeter(const std::string& strName);
