...
sla::Vec3f cross(const sla::Vec3f &a, const sla::Vec3f &b, const sla::Vec3f &c)
{
  ...
  float b1 = b(1)-c(1);
  float b2 = b(2)-c(2);
  return sla::Vec3f(a1*b2 - a2*b1, a2*b0 - a0*b2, a0*b1 - a1*b0);
}
...
{
  sla::Vec3f ba(b(0)-a(0), b(1)-a(1), b(2)-a(2));
  sla::Vec3f xa(x(0)-a(0), x(1)-a(1), x(2)-a(2));
...
sla::Vec3f  v1(t2(0)-t1(0), t2(1)-t1(1), t2(2)-t1(2));
sla::Vec3f  v2(t3(0)-t1(0), t3(1)-t1(1), t3(2)-t1(2));
sla::Vec3f  n = cross(v1,v2);
...
sla::Vec3f   pp(x(0)-f*n(0), x(1)-f*n(1), x(2)-f*n(2));
