...
const int kFleaMaxPacketSize = 5000000;
              ...
              int y __attribute__ ((unused)))
{
	...
	case 27:
	case 'q':
	case 'Q': //this will quit without saving
		exit(0);
		break;
	case '1':
		delta = 1;
	...
	case 'R' :
	case 'r':
		fprintf(stderr, "%d %lf r\n", flea_pkt_num, currFlea_timestamp);
		printf("%d %f r\n", flea_pkt_num, currFlea_timestamp);
		break;
	case 'G' :
	case 'g':
		fprintf(stderr, "%d %lf g\n", flea_pkt_num, currFlea_timestamp);
		printf("%d %f g\n", flea_pkt_num, currFlea_timestamp);
		break;
	case 'Y' :
	case 'y':
		fprintf(stderr, "%d %lf y\n", flea_pkt_num, currFlea_timestamp);
		printf("%d %f y\n", flea_pkt_num, currFlea_timestamp);
		break;
	case 'M' :
	case 'm':
