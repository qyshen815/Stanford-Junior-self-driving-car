...
public:
	...
	virtual void ann_search(ANNSearchInputs *, ANNmin_k *, ANNdist) = 0;		// tree search
...
public:
	...
	virtual void ann_search(ANNSearchInputs *, ANNmin_k *, ANNdist);			// standard search
...
public:
	...
	virtual void ann_search(ANNSearchInputs *inputs, ANNmin_k *, ANNdist);			// standard search
	virtual void ann_pri_search(ANNdist);		// priority search
	virtual void ann_FR_search(ANNdist);		// fixed-radius search
};
