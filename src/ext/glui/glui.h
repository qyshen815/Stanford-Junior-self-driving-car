...
public:
    ...
    void         adjust_glut_xy( __attribute__ ((unused)) int &x, int &y ) { y = h-y; }
...
public:
    ...
    virtual int mouse_down_handler( __attribute__ ((unused)) int local_x, __attribute__ ((unused)) int local_y )                 { return false; }
    virtual int mouse_up_handler( __attribute__ ((unused)) int local_x, __attribute__ ((unused)) int local_y, __attribute__ ((unused)) bool inside )       { return false; }
    virtual int mouse_held_down_handler( __attribute__ ((unused)) int local_x, __attribute__ ((unused)) int local_y, __attribute__ ((unused)) bool inside) { return false; }
    virtual int key_handler( __attribute__ ((unused)) unsigned char key, __attribute__ ((unused)) int modifiers )                { return false; }
    virtual int special_handler( __attribute__ ((unused)) int key, __attribute__ ((unused)) int modifiers )                       { return false; }

    virtual void update_size( void )     { }
    virtual void idle( void )            { }
    virtual int  mouse_over( __attribute__ ((unused)) int state, __attribute__ ((unused)) int x, __attribute__ ((unused)) int y ) { return false; }

    virtual void enable( void ); 
    virtual void disable( void );
    virtual void activate( __attribute__ ((unused)) int how )     { active = true; }
    ...
    */
    ...
    virtual void set_text( __attribute__ ((unused)) const char *t )   {}
